...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        for (int i = 0; i < DIGIT_BUTTONS; i++) {
            ...
            this.bDigits[i] = new JButton(iString);
        }
         ...
         * to bottom
         */
        mainButtonPanel.add(this.bDigits[NNCalcView1.SEVEN]);
        mainButtonPanel.add(this.bDigits[NNCalcView1.EIGHT]);
        mainButtonPanel.add(this.bDigits[NNCalcView1.NINE]);
        mainButtonPanel.add(this.bAdd);
        mainButtonPanel.add(this.bDigits[NNCalcView1.FOUR]);
        mainButtonPanel.add(this.bDigits[NNCalcView1.FIVE]);
        mainButtonPanel.add(this.bDigits[NNCalcView1.SIX]);
    ...
    /* Sets registers the given controller as an observer of the view class */
    @Override
    ...
    /*
     * Update text of each text area, update whether buttons for certain
